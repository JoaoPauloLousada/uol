...
/**
 * Audio player class that handles audio file playback, transport control, and audio processing
 * This class inherits from AudioSource and provides functionality for loading, playing, stopping,
 * and controlling audio playback with features like gain control, speed adjustment, and position seeking.
 */
class DJAudioPlayer : public AudioSource {
  public:
     ...
     * @param _formatManager Reference to the audio format manager for handling different audio formats
     */
